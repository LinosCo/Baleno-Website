...
export default function NewBookingWizardPage() {
  ...
  const calculatePrice = () => {
    ...
    if (selectedResource.minPrice) {
      const minPriceNum = parseFloat(selectedResource.minPrice.toString());
      if (totalPrice < minPriceNum) {
        totalPrice = minPriceNum;
      }
    }
    ...
    <div className="min-vh-100" style={{
      ...
      <div className="container py-4">
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          ...
          {error && (
            <div className="mb-4 p-4 d-flex align-items-start" role="alert" style={{
              borderRadius: '16px',
          ...
          {success && (
            <div className="mb-4 p-4 d-flex align-items-center" role="alert" style={{
              borderRadius: '16px',
              backgroundColor: '#d1f2eb',
              border: '1px solid #28a745',
              color: '#155724'
            }}>
              <svg className="me-3 flex-shrink-0" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
                <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z"/>
              </svg>
                        ...
                        <div className="row align-items-center">
                          ...
                          <div className="col-md-6 text-md-end">
                            ...
                            {selectedResource?.minPrice && (() => {
                              ...
                              const minPriceNum = parseFloat(selectedResource.minPrice.toString());
                              return basePrice < minPriceNum;
                            })() && (
                              <div className="small text-info mt-1">
                                <svg width="14" height="14" fill="currentColor" className="me-1" viewBox="0 0 16 16">
                                  <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
                                </svg>
                                Tariffa minima applicata: €{parseFloat(selectedResource.minPrice.toString()).toFixed(2)}
                              </div>
                            )}
                          </div>
                        </div>
