  ...
  return (
    <AdminLayout>
      <div>
        {/* Header */}
        <div className="mb-4">
          <h1 className="h3 fw-bold mb-1" style={{ color: '#2B548E' }}>Dashboard</h1>
          ...
          <div className="col-md-6 col-xl-3">
            <Link href="/admin/bookings" className="text-decoration-none">
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = '0 8px 20px rgba(43, 84, 142, 0.15)';
              }}
              onMouseLeave={(e) => {
                ...
                <div className="card-body py-3 px-4">
                  <div className="d-flex justify-content-between align-items-start mb-2">
                    <span className="text-muted small fw-semibold">Prenotazioni</span>
                    <svg width="20" height="20" fill="currentColor" style={{ color: '#2B548E' }} viewBox="0 0 16 16">
          ...
          <div className="col-md-6 col-xl-3">
            <Link href="/admin/bookings" className="text-decoration-none">
              ...
              onMouseLeave={(e) => {
                ...
                <div className="card-body py-3 px-4">
                  <div className="d-flex justify-content-between align-items-start mb-2">
                    <span className="text-muted small fw-semibold">In Attesa</span>
                    <svg width="20" height="20" fill="currentColor" style={{ color: '#ffc107' }} viewBox="0 0 16 16">
          ...
          <div className="col-md-6 col-xl-3">
            <Link href="/admin/bookings" className="text-decoration-none">
              ...
              onMouseLeave={(e) => {
                ...
                <div className="card-body py-3 px-4">
                  <div className="d-flex justify-content-between align-items-start mb-2">
                    <span className="text-muted small fw-semibold">Approvate</span>
                    <svg width="20" height="20" fill="currentColor" style={{ color: '#28a745' }} viewBox="0 0 16 16">
                      <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
          ...
          <div className="col-md-6 col-xl-3">
            <Link href="/admin/payments" className="text-decoration-none">
              ...
              onMouseLeave={(e) => {
                ...
                <div className="card-body py-3 px-4">
                  <div className="d-flex justify-content-between align-items-start mb-2">
                    <span className="text-muted small fw-semibold">Entrate</span>
                    <svg width="20" height="20" fill="currentColor" style={{ color: '#28a745' }} viewBox="0 0 16 16">
              ...
              onMouseLeave={(e) => {
                ...
                <div className="card-body py-3 px-4">
                  <div className="d-flex align-items-center">
                    <div className="me-3">
                      <svg width="32" height="32" fill="currentColor" style={{ color: '#2B548E', opacity: 0.75 }} viewBox="0 0 16 16">
        ...
        <div className="card border-0 shadow-sm mb-4" style={{
          ...
          <div className="card-header bg-white border-0 py-3 px-4" style={{ borderRadius: '16px 16px 0 0' }}>
            <h2 className="h6 fw-bold mb-0" style={{ color: '#2B548E' }}>Prenotazioni Recenti</h2>
          </div>
              ...
              onMouseLeave={(e) => {
                ...
                <div className="card-body py-3 px-4">
                  <div className="d-flex align-items-center mb-2">
                    <svg width="24" height="24" fill="currentColor" style={{ color: '#2B548E' }} className="me-2" viewBox="0 0 16 16">
